...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO `details` (`Name`, `Roll No.`,  `Dept.`,`Hostel`)
  VALUES ('$fname','$roll','$dept','$hostel')";
...
<body>
    ...
    <form style="align-self:center; padding:30px 300px;" method="post">
        ...
        <div class="input-group mb-3">
            ...
            <input name="roll" type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
        </div>
        <div class="input-group mb-3">
            <span class="input-group-text" id="inputGroup-sizing-default"> Dept.𝅸 𝅸 𝅸 𝅸 𝅸 𝅸 𝅸 𝅸 𝅸 𝅸 </span>
            <input name="dept" type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
        </div>
        <div class="input-group mb-3">
            <span class="input-group-text" id="inputGroup-sizing-default">Hostel 𝅸 𝅸 𝅸 𝅸 𝅸 𝅸 𝅸</span>
            <input name="hostel" type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
        </div>
